...
const mainOpen='<script type="module">',mainScriptStart=html.indexOf(mainOpen),mainScriptEnd=html.indexOf('</script>',mainScriptStart+mainOpen.length),externalKpPos=html.lastIndexOf('kp-enhancement.js?v=4'),externalPtkPos=html.lastIndexOf('ptk-swasta-enhancement.js?v=1');
if(mainScriptStart<0||mainScriptEnd<0||externalKpPos<=mainScriptEnd||externalPtkPos<=mainScriptEnd) throw new Error('Modul enhancement tidak berada di luar script utama.');
