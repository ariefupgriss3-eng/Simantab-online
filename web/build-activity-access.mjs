...
for(const [file,marker,version] of MODS){
 let code='';
 const forceRemote=['pengawas-menu-scope.js','pengawas-dashboard-kadin.js','super-admin-merge-pengawas.js'].includes(file);
