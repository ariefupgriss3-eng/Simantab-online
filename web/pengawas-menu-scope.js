...
const ALLOWED=new Set(['dashboard','attendance','profile','services','monitoring','notifications','needs','promotion','discipline','tpg','status','docs']);
const items=[
 ['dashboard','▦','Dashboard Sekolah Binaan'],
 ['attendance','✍️','Daftar Hadir Kegiatan'],
 ['profile','♙','Profil'],
