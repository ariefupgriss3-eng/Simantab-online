...
console.log(JSON.stringify({developerFooter:true,loginDeveloperBranding:true,developer:'M. Arief Rohman, S.Pd.SD., M.Si., M.Pd., M.Pd',unit:'Dinas Pendidikan dan Kebudayaan',year:2026,svgIcons:true,kasimRoleLabel:'Admin KSPS • KP/PAK/Jabfung/SKP-PAK',productionUntouched:true}));
