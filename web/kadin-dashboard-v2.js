...
]);const er=rr.find(x=>x.error)?.error;if(er)throw er;cached={schools:rr[0].data||[],needs:rr[1].data||[],subs:rr[2].data||[],ptk:rr[3].data||[],acts:rr[4].data||[],unread:rr[5].count||0};cacheAt=Date.now();return cached}
