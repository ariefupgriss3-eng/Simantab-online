...
console.log(JSON.stringify({gtkNeedsProgress:true,version:2,scope:{kepalaSekolah:'own-school-edit',gtk:'own-school-read',pengawas:'assigned-district-read',dinas:'district-wide-all-schools'},workflow:['DRAFT','SUBMITTED','VERIFIED','REVISION'],roleScoped:true,existingNeedsDataUntouched:true}));
