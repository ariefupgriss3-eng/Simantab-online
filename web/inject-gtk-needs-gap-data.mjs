...
if(!html.includes('./school-status-access-v1.js?v=5'))throw new Error('School status access v5 tidak ditemukan pada hasil final build.');
await fs.writeFile(outputPath,html);
console.log(JSON.stringify({gtkNeedsOverlayDisabled:true,coreVersion:31,schoolStatusVersion:5,gapDataInCore:true,verificationInCore:true,clickableGapBreakdowns:true,negeriOnlyInCore:true,positiveShortageAggregation:true,legacyRenderersRemoved:true}));