...
if(!html.includes('./gtk-needs-progress.js?v=14'))throw new Error('GTK needs core v14 tidak ditemukan pada hasil final build.');
...
console.log(JSON.stringify({gtkNeedsOverlayDisabled:true,coreVersion:14,schoolStatusVersion:4,gapDataInCore:true,verificationInCore:true,clickableGapBreakdowns:true,negeriOnlyInCore:true,positiveShortageAggregation:true,legacyRenderersRemoved:true}));