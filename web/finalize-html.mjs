...
if(!/SIMANTAB_KEPALA_DINAS_INFOGRAPHIC_V7/.test(kadinCode))throw new Error('Dashboard pimpinan mobile-stable v7 tidak valid.');
...
if(!/SIMANTAB_LEADER_DASHBOARD_AUTHORITATIVE_V2/.test(leaderDashboardCode))throw new Error('Leader dashboard authoritative v2 tidak valid.');
