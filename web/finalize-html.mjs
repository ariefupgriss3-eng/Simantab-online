...
if(!/SIMANTAB_GTK_REDISTRIBUTION_ANALYSIS_V2/.test(gtkRedistributionCode))throw new Error('GTK redistribution analysis v1 tidak valid.');
...
const modules=[
 ...
 ['gtk-redistribution-analysis.js',2],
