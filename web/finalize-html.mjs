...
if(!/SIMANTAB_GTK_REDISTRIBUTION_ANALYSIS_V4/.test(gtkRedistributionCode))throw new Error('GTK redistribution analysis v4 tidak valid.');
...
const modules=[
 ...
 ['gtk-redistribution-analysis.js',4],
