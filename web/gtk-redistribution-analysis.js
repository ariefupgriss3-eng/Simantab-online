/* SIMANTAB_GTK_REDISTRIBUTION_ANALYSIS_V6 */
(async()=>{
...
function studySection(m){
 ...
 '<div class="gar-study-source" style="margin-top:10px">Sumber internal: '+esc(SD_STUDY.title)+' — '+esc(SD_STUDY.version)+', '+esc(SD_STUDY.date)+'; dasar hukum '+esc(SD_STUDY.legalBasis)+'; cut-off peserta didik '+esc(SD_STUDY.studentCutoff)+'. Jarak kajian bersifat indikatif dan tidak sama dengan rute murid.</div></div>';
}
